                ...
                <Pressable style={styles.sheet} onPress={(e) => e.stopPropagation()}>
                    ...
                    <View style={styles.content}>
                        {hasCompanyDetails ? (
                            ...
                            <>
                                {/* Stands sans entreprise (Service, Salle, etc.) */}
                                <Text style={styles.companyName}>
                                    {stand.number || stand.company_name || 'Stand'}
                                </Text>

                                {/* Afficher la catégorie si ce n'est pas "Entreprise" */}
                                {stand.category && stand.category !== 'Entreprise' && (
                                    <View style={styles.fieldContainer}>
                                ...
                                {/* Message pour stands Entreprise sans match */}
                                {(!stand.category || stand.category === 'Entreprise') && (
